...
# CLI
# ══════════════════════════════════════════════════════════════════════════
# AI-assisted code: generated with guidance from ChatGPT, reviewed and tested by the author
def main():
    p = argparse.ArgumentParser(description="Windows admin toolkit (IT 390R)")
    p.add_argument("--task", required=True,
                   choices=["win-events", "win-pkgs", "win-services", "win-uptime", "win-startup"],
    ...
    # AI-assisted code: generated with guidance from ChatGPT, reviewed and tested by the author
        ...
        import subprocess
        try:
            result = subprocess.run("net statistics workstation", capture_output=True, text=True, shell=True)
            ...
            for line in output.splitlines():
                ...
                print("Could not find uptime information.")
